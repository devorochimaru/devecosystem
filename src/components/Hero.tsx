  ...
  return (
    <section className="hero-section relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      ...
      <div className="absolute inset-0 bg-[#0a0a0f]">
        {/* Constrain particle canvas so it can't push layout on small screens */}
        <div className="hero-particle-wrapper">
          <ParticleBackground />
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="hero-eyebrow flex items-center justify-center gap-2 mb-8"
        >
          ...
          <h1
            className="hero-brand uppercase tracking-wider text-5xl sm:text-6xl md:text-7xl lg:text-[5rem]"
            style={{
              fontWeight: 700,
        ...
        <motion.p
          ...
          className="hero-subtitle text-lg md:text-xl text-[#a8a8b8] max-w-3xl mx-auto mb-10 leading-relaxed px-2"
        ...
        <motion.div
          ...
          className="hero-cta-row flex flex-col sm:flex-row gap-4 justify-center"
        >
          <a
            href="#panels"
            className="hero-cta-primary group relative px-8 py-4 rounded-xl overflow-hidden w-full sm:w-auto"
            style={{
          ...
          <a
            href="#contact"
            className="hero-cta-outline group relative px-8 py-4 rounded-xl overflow-hidden w-full sm:w-auto"
            style={{
